(function (global, factory) {
  ...
  function getOptions(shared, fromBinding) {
    return _extends(_extends({}, shared), fromBinding);
  }
  ...
  */
  ...
  var increase = function increase(target, axis, withPlaceholder) {
    if (withPlaceholder && withPlaceholder.increasedBy) {
      ...
      return _extends(_extends({}, target), {}, (_extends2 = {}, _extends2[axis.end] = target[axis.end] + withPlaceholder.increasedBy[axis.line], _extends2));
    }
  ...
  var scrollDroppable = (function (droppable, newScroll) {
    ...
    var frame = _extends(_extends({}, scrollable), {}, {
      scroll: {
    ...
    var result = _extends(_extends({}, droppable), {}, {
      frame: frame,
      subject: subject
    });
  ...
  var moveToNextCombine = (function (_ref) {
    ...
    function getImpact(target) {
      ...
      return _extends(_extends({}, previousImpact), {}, {
        at: at
      });
    }
  ...
  var isPartiallyVisible = function isPartiallyVisible(args) {
    return isVisible(_extends(_extends({}, args), {}, {
  ...
  var speculativelyIncrease = (function (_ref) {
    ...
    var newImpact = _extends(_extends({}, impact), {}, {
      displaced: {
        all: last.all,
        invisible: invisible,
        visible: visible
  ...
  var withMaxScroll = function withMaxScroll(frame, max) {
    return _extends(_extends({}, frame), {}, {
      scroll: _extends(_extends({}, frame.scroll), {}, {
        max: max
      })
    });
  };
  ...
  var addPlaceholder = function addPlaceholder(droppable, draggable, draggables) {
    ...
    if (!frame) {
      ...
      return _extends(_extends({}, droppable), {}, {
        subject: _subject
      });
    }
  ...
  var patchDroppableMap = (function (droppables, updated) {
    ...
    return _extends(_extends({}, droppables), {}, (_extends2 = {}, _extends2[updated.descriptor.id] = updated, _extends2));
  });
  ...
  var update = (function (_ref) {
    ...
    var result = _extends(_extends({}, state), {}, {
      current: current,
      dimensions: {
        draggables: dimensions.draggables,
  ...
  var recompute = (function (_ref) {
    ...
    return _extends(_extends({}, impact), {}, {
      displaced: displaced
    });
  });
  ...
  var offsetDraggable = (function (_ref) {
    ...
    var moved = _extends(_extends({}, draggable), {}, {
      placeholder: _extends(_extends({}, draggable.placeholder), {}, {
        client: client
      }),
      client: client,
      page: page
  ...
  var publishWhileDraggingInVirtual = (function (_ref) {
    ...
    var droppables = _extends(_extends({}, state.dimensions.droppables), toDroppableMap(withScrollChange));
    ...
    var draggables = _extends(_extends({}, state.dimensions.draggables), updatedAdditions);
    ...
    var draggingState = _extends(_extends({
      phase: 'DRAGGING'
    }, state), {}, {
      phase: 'DRAGGING',
      impact: impact,
    ...
    var dropPending = _extends(_extends({
      phase: 'DROP_PENDING'
    }, draggingState), {}, {
      phase: 'DROP_PENDING',
      reason: state.reason,
  ...
  var reducer = (function (state, action) {
    ...
    if (action.type === 'UPDATE_DROPPABLE_IS_ENABLED') {
      ...
      var updated = _extends(_extends({}, _target), {}, {
        isEnabled: isEnabled
      });
    ...
    if (action.type === 'UPDATE_DROPPABLE_IS_COMBINE_ENABLED') {
      ...
      var _updated = _extends(_extends({}, _target2), {}, {
    ...
    if (action.type === 'UPDATE_VIEWPORT_MAX_SCROLL') {
      ...
      var withMaxScroll = _extends(_extends({}, state.viewport), {}, {
        scroll: _extends(_extends({}, state.viewport.scroll), {}, {
          max: maxScroll
        })
      });
    ...
    if (action.type === 'DROP_PENDING') {
      ...
      var newState = _extends(_extends({
        phase: 'DROP_PENDING'
      }, state), {}, {
        phase: 'DROP_PENDING',
        isWaiting: true,
  ...
  var getDropImpact = (function (_ref) {
    ...
    var withoutMovement = _extends(_extends({}, lastImpact), {}, {
      displaced: emptyGroups
    });
  ...
  var getPublisher = (function (getResponders, announce) {
    ...
    var update = function update(critical, impact) {
      ...
      var data = _extends(_extends({}, getDragStart(critical, dragging.mode)), {}, {
        combine: combine,
    ...
    var abort = function abort() {
      ...
      var result = _extends(_extends({}, getDragStart(dragging.lastCritical, dragging.mode)), {}, {
        combine: null,
        destination: null,
        reason: 'CANCEL'
      });
  ...
  var scroll$1 = (function (_ref) {
    var state = _ref.state,
        ...
        disableVerticalAutoScroll = _ref.disableVerticalAutoScroll;
  ...
  var createFluidScroller = (function (_ref) {
    ...
    var tryScroll = function tryScroll(state) {
      ...
      scroll$1({
        ...
        dragStartTime: dragStartTime,
        shouldUseTimeDampening: shouldUseTimeDampening,
        disableVerticalAutoScroll: disableVerticalAutoScroll
      });
    };
  ...
  function App(props) {
    ...
    var autoScroller = useMemo(function () {
      return createAutoScroller(_extends(_extends({
        scrollWindow: scrollWindow,
    ...
    }, [disableVerticalAutoScroll, dimensionMarshal.scrollDroppable, lazyDispatch]);
  ...
  var makeMapStateToProps$1 = function makeMapStateToProps() {
    ...
    var idleWithoutAnimation = _extends(_extends({}, idleWithAnimation), {}, {
